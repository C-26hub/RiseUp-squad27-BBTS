document.addEventListener("DOMContentLoaded", () => {
   ...
   // --- PAGINA REVISÃO ---
// Botões: Voltar e editar | Confirmar cadastro
...
// Verifica se estamos na página revisao.html
if (currentPage === "revisao.html") {

    // Voltar e editar → volta uma página no fluxo
    if (reviewBackButton) {
        reviewBackButton.addEventListener("click", (e) => {
            e.preventDefault();
            navigateFlow(-1);  // volta para upload_arquivos.html
        });
    }

    // Confirmar cadastro → vai para confirmacao.html
...
document.querySelector(".continue-button.confirmation-button").addEventListener("click", function () {
    window.location.href = "../../5 - TELA_STARTUP/telas/index.html";
    });
